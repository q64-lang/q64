...
| `qube wit import <file.wit> [--out <file>]` | Parse a **foreign** WIT package (a component in any language) and print its q64 binding preview — the **consume** direction (WIT rung 5). The package-level wrapper over [`q64 wit import`](./q64-cli.md); the compiler owns the WIT parser + the WIT→q64 type mapping. |
...
q64 build <entry.q>
  ...
  --module dev.q64.audio=<absolute-path>/dev.q64.audio-0.3.0/src/lib.q
  --module com.openai.whisper=<absolute-path>/com.openai.whisper-1.0.2/src/lib.q
  --module dev.example.local_dep=/abs/path/to/local-dep/src/lib.q   # path: deps look identical
